...
#pragma comment(linker,"/alternatename:__imp_?FormatMessageW@win32@fast_io@@YGIIPB_WIIPA_WIPAX@Z=__imp__FormatMessageW@28")
...
#pragma comment(linker,"/alternatename:__imp_?CreateFileMappingW@win32@fast_io@@YGPAXPAXPAUsecurity_attributes@12@IIIPB_W@Z=__imp__CreateFileMappingW@24")
...
#pragma comment(linker,"/alternatename:__imp_?GetModuleHandleW@win32@fast_io@@YGPAXPB_W@Z=__imp__GetModuleHandleW@4")
...
#pragma comment(linker,"/alternatename:__imp_?GetUserDefaultLocaleName@win32@fast_io@@YGHPA_WH@Z=__imp__GetUserDefaultLocaleName@8")
...
#pragma comment(linker,"/alternatename:__imp_?GetTempPathW@win32@fast_io@@YGIIPA_W@Z=__imp__GetTempPathW@8")
...
#pragma comment(linker,"/alternatename:__imp_?CreateFileW@win32@fast_io@@YGPAXPB_WIIPAUsecurity_attributes@12@IIPAX@Z=__imp__CreateFileW@28")
...
#pragma comment(linker,"/alternatename:__imp_?GetAddrInfoW@win32@fast_io@@YGHPB_W0PBU?$win32_family_addrinfo@$00@12@PAPAU312@@Z=__imp__GetAddrInfoW@16")
