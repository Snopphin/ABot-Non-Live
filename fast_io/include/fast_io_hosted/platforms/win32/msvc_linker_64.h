...
#pragma comment(linker,"/alternatename:__imp_?LoadLibraryExW@win32@fast_io@@YAPEAXPEB_WPEAXI@Z=__imp_LoadLibraryExW")
#pragma comment(linker,"/alternatename:__imp_?FormatMessageA@win32@fast_io@@YAIIPEBDIIPEADIPEAX@Z=__imp_FormatMessageA")
#pragma comment(linker,"/alternatename:__imp_?FormatMessageW@win32@fast_io@@YAIIPEB_WIIPEA_WIPEAX@Z=__imp_FormatMessageW")
...
#pragma comment(linker,"/alternatename:__imp_?GetAddrInfoW@win32@fast_io@@YAHPEB_W0PEBU?$win32_family_addrinfo@$00@12@PEAPEAU312@@Z=__imp_GetAddrInfoW")
...
#pragma comment(linker,"/alternatename:__imp_?NtResumeThread@nt@win32@fast_io@@YAIPEAXPEAI@Z=NtResumeThread")
#pragma comment(linker,"/alternatename:__imp_?ZwResumeThread@nt@win32@fast_io@@YAIPEAXPEAI@Z=ZwResumeThread")
